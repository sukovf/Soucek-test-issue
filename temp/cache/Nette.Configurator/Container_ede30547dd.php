...
// source: D:\web_Dev\php_tets\php_test\app/config/config.local.neon 

class Container_ede30547dd extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_ede30547dd $container)
			{
