...
class Container_00f2715095 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Services\Calculator' => [1 => ['Calculator']],
	...
	public function createService__Calculator(): App\Services\Calculator
	{
		$service = new App\Services\Calculator;
		return $service;
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'D:\web_Dev\php_tets\php_test\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_00f2715095 $container)
			{
